...
const BlogFormUpdate = (props) => {
    ...
    const ShowPopup = () => {
        if (success) {
            return (
                <>
                    <SuccessPopup message="Your Blog Successfully Updated" />
                </>
            )
        }
    }
                ...
                <form className="w-full" onSubmit={updatePost}>
                    <div className="w-full gap-2 justify-between flex flex-col">
                        ...
                        <div className="w-full flex flex-col-reverse sm:flex-row gap-3 mt-3">
                            ...
                            <button type="submit" className="bg-blue-950 px-2 py-2 w-full sm:w-1/6 text-white font-medium rounded-md">Update Now &#128640;</button>
                        </div>
                    </div>
                </form>
            </div>
